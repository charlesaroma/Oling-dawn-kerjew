    ...
    <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-navy-900/15 bg-white/60 py-20 text-center">
      ...
      {skeleton && (
        <div className="mt-2 flex w-full max-w-[220px] flex-col items-center gap-2">
          <span className="h-2 w-full rounded-full bg-navy-900/8" />
          <span className="h-2 w-3/4 rounded-full bg-navy-900/8" />
          <span className="h-2 w-1/2 rounded-full bg-navy-900/8" />
        </div>
      )}
    </div>
  );
