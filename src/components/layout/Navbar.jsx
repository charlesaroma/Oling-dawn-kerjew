...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-ink-900/6 bg-[var(--color-surface)] shadow-elevated-lg backdrop-blur-md">
      <Container className="flex items-center justify-between gap-4 py-3">
        <NavLink to="/" className="flex min-w-0 items-center gap-3">
          <img src="/apple-touch-icon.png" alt="" className="h-10 w-10 shrink-0 rounded-full ring-1 ring-ink-900/5" />
        ...
        <button
          type="button"
          className="flex h-10 w-10 items-center justify-center rounded-full border border-ink-900/10 text-forest-800 transition-colors hover:bg-forest-50 md:hidden"
      ...
      <div
        className={`overflow-hidden border-t border-ink-900/6 bg-white transition-all duration-200 md:hidden ${
